  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-8 text-slate-100 font-sans">
      <div className="max-w-3xl w-full text-center">
        <h1 className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-fuchsia-400 mb-8">
          Play with AI
        </h1>
        
        <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-16 mb-12 shadow-lg backdrop-blur-sm">
          <p className="text-xl text-slate-400 italic">AI opponent logic and board will go here.</p>
        </div>
